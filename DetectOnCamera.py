...
# prints all files
print(dir_list)
image_name = input("Name of Location (without .jpg): ")
...
the_image = 'setup_image/{}.jpg'.format(image_name)
...
def detection(x):
    ...
    name = "{}/extract_detect/detect_{}-{}.jpg".format(curDir, image_name, x)
    print("Creating.. " + name)
...
def getImage(x):
    ...
    name = "{}/extract_detect/extract_{}-{}.jpg".format(curDir, image_name, x)
    print("Creating.. " + name)
